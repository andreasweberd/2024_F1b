...
int notendauer_05 = 1000;
int notendauer = 500;
int notendauer_2 = 250;
int notendauer_4 = 125;
int note_05 = (notendauer * 2) * 0.9;
int note = notendauer * 0.9;
int note_2 = (notendauer / 2) *0.9;
...
void setup() // Im Setup werden keine Informationen benötigt.
{
 ...
 int dauer[] = {
  ...
  note,  note,  note, note,
  note,  note_2,  note_2,  note, note,
  note,  note_2,  note_2,  note, note,
  NOTE_C4,note,  NOTE_D4,note,  NOTE_G3,note,
